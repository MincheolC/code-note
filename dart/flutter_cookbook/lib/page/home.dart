...
import 'package:cookbook/component/bottom_drawer.dart';
import 'package:cookbook/page/compose_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';
import 'package:provider/provider.dart';
import 'package:cookbook/model/router_provider.dart';

import 'package:cookbook/colors.dart';
import 'package:cookbook/model/email_store.dart';
import 'package:cookbook/router.dart';
import 'package:cookbook/settings_bottom_sheet.dart';
import 'package:cookbook/router/mail_view_router.dart';
          ...
          child: IconButton(
            ...
            onPressed: () {
              Provider.of<RouterProvider>(
                context,
                listen: false,
              ).routePath = const CookBookSearchPath();
            },
          ),
        );
      },
                ...
                return ListTile(
                  leading: ImageIcon(
                    ...
                    color: destination.name == currentlySelectedInbox
                        ...
                        : CookBookColors.white50.withOpacity(0.64),
                  ),
                  title: Text(
                    destination.name,
          ...
          InkWell(
            ...
            child: ListTile(
              leading: ImageIcon(
                ...
                color: CookBookColors.white50.withOpacity(0.64),
              ),
              title: Text(
                folder,
                style: theme.textTheme.bodyText2!.copyWith(
